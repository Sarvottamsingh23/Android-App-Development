...
import com.sarvoyas.newsapp.activity.VideoDetailsActivity;
...
public class YoutubeAdapter extends RecyclerView.Adapter<YoutubeAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(singleVideoItem.getSnippet().getThumbnails().getMaxres()!= null){
            ...
            Glide.with(context).load(singleVideoItem.getSnippet().getThumbnails().getStandard().getUrl()).placeholder(R.drawable.icon_youtube).placeholder(R.drawable.icon_youtube).into(holder.videoThumbnail);
